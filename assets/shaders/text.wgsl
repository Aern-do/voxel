// https://github.com/alexheretic/glyph-brush/blob/main/glyph-brush/examples/shader/text.vs
// https://github.com/alexheretic/glyph-brush/blob/main/glyph-brush/examples/shader/text.fs
...
fn vs_main(in: VertexInput) -> VertexOutput {
    ...
    out.clip_position = projection * vec4<f32>(pos, in.top_left.z, 1.0);
    out.color = in.color;
    return out;
}
...
fn fs_main(in: VertexOutput) -> @location(0) vec4<f32> {
    let alpha = textureSample(texture, texture_sampler, in.tex_pos).r;
